...
RUN sudo sudo git clone https://github.com/McCallTech/vendingMachineKata.git /vendingMachineKata && sudo chown user:user /vendingMachineKata && cp -R /vendingMachineKata /projects/vendingMachineKata
WORKDIR /projects
